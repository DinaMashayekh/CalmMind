...
Padding( 
padding: const EdgeInsets.only(top: 15, bottom: 5, right: 12, left: 2), 
...
Center(
  child: Row(
    ...
    children: [
      ...
      Text(' ${doctor?.name ?? 'No Doctor Selected'}'  ,
...
Center(
  child: Row(
    ...
    Padding( 
padding: const EdgeInsets.only(top: 20, bottom: 5, right: 12, left: 12), 
...
Padding( 
padding: const EdgeInsets.only(top: 15, bottom: 5, right: 12, left: 12), 
...
children: [ 
	...
	child: Text( 
		'Join', 
		style: TextStyle(color: Color(0xff87bfff), fontSize: 20), 
	), 
	), 
], 
), 
