...
class _MyQuestionsPage extends State<QuestionsPage> {
  ...
  final BottomNavigationBarExample bottomNavigationBarExample = BottomNavigationBarExample();
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    child:  Text("Mental health test",
    style: GoogleFonts.poppins(
    textStyle:TextStyle(color: Colors.black87, fontSize: 20.0, fontFamily: 'Poppins', fontWeight: FontWeight.bold),),
    ),
        ...
        Expanded(
          child: Form(
            ...
            Question(
                question: "Little interest or pleasure in doing things Feeling down, depressed, or hopeless?",
                isMandatory: true,
                answerChoices: const {
                  "Not at all": null,
                  "Several days": null,
