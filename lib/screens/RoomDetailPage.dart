...
import 'package:calm_mind/models/RoomMessageModel.dart';
...
List<RoomMessage> messages = [
    ...
    RoomMessage(messageContent: "Hey Kriss, I am doing fine dude. wbu?", messageType: "sender"),
    RoomMessage(messageContent: "ehhhh, doing OK.", messageType: "receiver"),
    RoomMessage(messageContent: "Is there any thing wrong?", messageType: "sender"),
  ];
  @override
                ...
                Expanded(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 6,),
                      Text("Dr. "+(widget.doctorname ?? ''),style: TextStyle(color: Colors.grey.shade600, fontSize: 13),),
                    ],
                  ),
                ),
